...
function ank_stripe_settings_setup() {
	add_options_page('Stripe Settings', 'Stripe Settings', 'manage_options', 'stripe-settings', 'ank_stripe_render_options_page');
}
add_action('admin_menu', 'ank_stripe_settings_setup');
 
function ank_stripe_render_options_page() {
...
function ank_stripe_register_settings() {
	// creates our settings in the options table
	register_setting('stripe_settings_group', 'stripe_settings');
}
add_action('admin_init', 'ank_stripe_register_settings');
