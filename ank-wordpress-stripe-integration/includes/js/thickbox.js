...
function tb_showIframe(){
	...
	jQuery("#TB_window").css({'visibility':'visible'});
        ...
        // customized by Ankur
        var iframe = document.getElementById("TB_iframeContent").contentWindow;
        var height=iframe.jQuery(".ak-stripe-popup-content").outerHeight() + 28; //28 is offset of loading image
        jQuery("#TB_iframeContent").css({height: height});
