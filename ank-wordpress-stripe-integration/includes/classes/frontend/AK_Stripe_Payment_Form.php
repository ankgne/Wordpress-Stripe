        ...
        if (isset($_GET['payment']) && $_GET['payment'] == 'paid') {
            ...
            <form action="" method="POST" id="ak-stripe-payment-form">
                <p class="form-group">
                    ...
                    <br>
                    <input name="customername" type="text" size="40" autocomplete="off" class="card-name form-control"/>
                </p>
                <p class="form-group">
                    <?php _e("Email Address", 'ak_stripe'); ?>
                    <br>
                    <input name="emailadress" type="text" size="40" autocomplete="off" class="card-email form-control"/>
                </p>
                <p class="form-group">
                    <?php _e('Card Number', 'ak_stripe'); ?>
                    <br>
                    <input type="text" size="40" autocomplete="off" class="card-number cc-number form-control"/>
                </p>
                <p class="form-group">
